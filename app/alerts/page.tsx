...
export default function AlertsPage() {
  return <AppShell active="alerts">
    ...
    <div className="alert-notice"><span>i</span><p><strong>Persistent V2 alert rules</strong> Rules are saved in Supabase and evaluated against each minute snapshot while the live dashboard is running. In-app matches are counted here; offline scheduling and phone/email delivery are a later upgrade.</p></div>
    <AlertsManager />
