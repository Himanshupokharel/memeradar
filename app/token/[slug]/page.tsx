  ...
  return <AppShell active="" source={live ? 'dexscreener' : 'mock'} updatedAt={new Date().toISOString()}>
    ...
    <div className="detail-grid">
      <section className="panel chart-card">
        <div className="panel-head"><div><span className="panel-kicker">MARKET ACTIVITY</span><h2>Current 5-minute momentum</h2></div><span className="result-count">LIVE SNAPSHOT</span></div>
        ...
        <p className="chart-note">Illustrative shape derived from current 5-minute change and trade intensity—not tick-level price history.</p>
      </section>
